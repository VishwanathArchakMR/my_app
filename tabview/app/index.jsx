...
export default function App() {
  ...
  const handleMessage = () => {
    // Add your logic for messaging here
    alert('Message button pressed!');
  };

  const handleFollow = () => {
    // Add your logic for following here
  ...
  return (
    <ScrollView contentContainerStyle={styles.scroll}>
      <View style={styles.container}>
        ...
        <Text style={styles.name}>Vishwanath Archak</Text>
        ...
        <View style={styles.row}>
          ...
          <TouchableOpacity style={[styles.button, styles.primary]} onPress={handleFollow}>
